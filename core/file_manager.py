...
def show_rename_dialog(parent, old_path):
    ...
    new_name, ok = QInputDialog.getText(parent, "Renombrar", "Nuevo nombre:", QLineEdit.EchoMode.Normal, old_name)
    ...
    if ok and new_name and new_name != old_name:
        ...
        if os.path.exists(new_path):
            QMessageBox.warning(parent, "Error de conflicto", "Ya existe un archivo con ese nombre en esta carpeta.")
            return None
        ...
        try:
            ...
            QMessageBox.critical(parent, "Archivo Bloqueado", 
            ...
            QMessageBox.critical(parent, "Error", f"Ocurrió un error inesperado al renombrar:\n{str(e)}")
